  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        or a <a href="/components/textarea-autosize/">TextareaAutosize</a>.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-16" component="div">
        ...
        used to add a prefix, a suffix or an action to an input. For instance,
      ...
      <Typography className="mb-16" component="div">
        ...
        of inputs. Using <code>{`none`}</code> (default) will not apply margins
        to the <code>{`FormControl`}</code>, whereas <code>{`dense`}</code> and{' '}
        <code>{`normal`}</code> will.
        <code>{`dense`}</code> and <code>{`normal`}</code> alter other styles to
      ...
      <Typography className="mb-16" component="div">
        ...
        missing from the <code>{`TextField`}</code> component. This is on
        purpose. The component takes care of the most used properties, then
        it&#39;s up to the user to use the underlying component shown in the
        following demo. Still, you can use <code>{`inputProps`}</code> (and{' '}
...
`}
      ...
      <Typography className="mb-16" component="div">
        The provided input component should handle the <code>{`inputRef`}</code>{' '}
...
`}
      ...
      <ul>
        <li>
          If you are using the <code>{`TextField`}</code> component, you just
          have to provide a unique <code>{`id`}</code>.
        </li>
