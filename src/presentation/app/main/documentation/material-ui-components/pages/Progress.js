  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        inform users about the status of ongoing processes, such as loading an
        app, submitting a form, or saving updates. They communicate an app’s
        state and indicate available actions, such as whether users can navigate
      ...
      <Typography className="mb-16" component="div">
        When displaying progress for a sequence of processes, indicate overall
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>{`ButtonBase`}</code> component ensures that the user feels that
        the system is reacting instantaneously. Normally, no special feedback is
      ...
      <Typography className="mb-16" component="div">
        ...
        CircularProgress ring widths. You should run processor intensive
        operations in a web worker or by batch in order not to block the main
        rendering thread.
      </Typography>
      <Typography className="mb-16" component="div">
        {' '}
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>{`disableShrink`}</code> property to mitigate the issue. See{' '}
