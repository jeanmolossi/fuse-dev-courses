  ...
  return (
    <>
      ...
      <Typography className="description">
        Snackbars provide brief messages about app processes. The component is
        also known as a toast.
      </Typography>

      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/snackbars.html">
          Snackbars
        </a>{' '}
        inform users of a process that an app has performed or will perform.
        They appear temporarily, towards the bottom of the screen. They
      ...
      <Typography className="mb-16" component="div">
        ...
        alt="stars/&gt; src="https://img.shields.io/npm/dm/notistack.svg"
        alt="npm downloads/&gt;
      </Typography>
      <Typography className="mb-16" component="div">
      ...
      <ul>
        <li>
          ...
          to use the <code>{`autoHideDuration`}</code> prop, it&#39;s
          recommended to give the user{' '}
